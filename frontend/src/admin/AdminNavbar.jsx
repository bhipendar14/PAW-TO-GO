...
const AdminNavbar = () => {
  ...
  const getInitial = (name) => (name ? name.charAt(0).toUpperCase() : "A"); // Default "A" for Admin
  ...
  return (
    <nav className="navbar" style={{ backgroundColor: theme, transition: "0.3s ease-in-out" }}>
      ...
      <ul className="nav-links">
        <li><Link to="/admin/home" style={{ color: theme === "black" ? "white" : "black" }}>Home</Link></li>
        <li><Link to="/admin/customer" style={{ color: theme === "black" ? "white" : "black" }}>Customer</Link></li>
        <li><Link to="/admin/employee" style={{ color: theme === "black" ? "white" : "black" }}>Employee</Link></li>
      </ul>
