    ...
    <>
      ...
      <div className="chat-container">
        ...
        <div className="user-list">
          <h2>Employee</h2>
          {customers.length === 0 ? (
            <p>No employees available.<br/> <br/> <div className="loader" style={{ color: "green" , fontSize: "20px" ,fontbold: "bold" }}>The server is connecting...</div></p>
          ) : (
        ...
        <div className="chat-window">
          {selectedCustomer ? (
            ...
            <p>Select a employee to chat with.</p>
          )}
        </div>
      </div>
    </>
